...
import br.com.landucci.ficharpg.domain.personagem.factory.PersonagemFactory;
...
public class FicharpgApplication {
	...
	public static void main(String[] args) {
		...
		var armadura = ArmaduraFactory.create("Armadura de Couro", 1000D, 11, 0, false, 5D, 
				tipoArmadura);
		mellianTallan.vestirArmadura(armadura);
		System.out.println(mellianTallan.toJSON());
	}
